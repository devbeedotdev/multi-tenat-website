...
export default async function VariantCProductDetailPage({
  tenant,
  params,
  ...
  return (
    <main className="min-h-screen bg-gray-50 flex relative">
      ...
      <section className="flex-1 min-w-0 px-3 md:px-6 py-6 mt-16 md:mt-0">
        <div className="mx-auto flex w-full max-w-7xl flex-col gap-8">
          {/* Breadcrumb */}
          <nav className="flex items-center gap-2 text-xs text-slate-500 md:text-sm py-2">
            <Link
              href={`/${params.domain}`}
