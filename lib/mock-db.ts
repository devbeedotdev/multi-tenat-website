...
// Internal-only tenant seed data used for generating mock products.
// Live tenant data is now stored in PostgreSQL via Prisma.
const seedTenants: Record<string, Tenant> = {
  "client.com": {
...
// Legacy product and categories seed data have been removed in favour of
// the Prisma-backed Product model stored in PostgreSQL.
