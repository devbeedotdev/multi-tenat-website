...
//           {tenant.logoUrl ? (
//             /* Stunning Image Effect: Hover scale + Ring offset */
//             <div className="group relative flex flex-col items-center">
//               {/* Container: w-10 on mobile, w-14 on desktop */}
//               <div className="w-12 h-12 md:w-14 md:h-14 rounded-full border-2 border-primary p-0.5 transition-all duration-300 group-hover:scale-105 group-active:scale-95 cursor-pointer">
//                 {/* Image Wrapper: Must be 'relative' for Next.js fill to work */}
//                 <div className="relative w-full h-full rounded-full overflow-hidden">
//                   <Image
//                     onClick={() => alert("clicked")}
//                     src={tenant.logoUrl}
//                     alt="Logo"
//                     fill // Automatically fills the responsive container
//                     sizes="(max-width: 768px) 40px, 56px" // Optimizes image loading
...
//             </div>
//           ) : (
//             /* Stunning Home Effect: Ghost background + Slide-in text */
//             <button
//               onClick={() => alert("help")}
...
//           {/* Search Button */}
//           <button className="h-11 sm:h-12  px-5 rounded-xl bg-primary text-white font-medium transition duration-200 hover:opacity-90 active:scale-95 flex items-center justify-center">
//             {/* Mobile: Icon */}
